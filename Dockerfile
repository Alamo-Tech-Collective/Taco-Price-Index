...
# docker build -t taco_price_index .
# docker run -d -p 3000:3000 -e DATABASE_URL=<postgres url> -e RAILS_MASTER_KEY=<value from config/master.key> --name taco_price_index taco_price_index
